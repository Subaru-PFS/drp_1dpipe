...
class RedshiftCoCandidates:
    ...
    def add_object_lines(self, object_type, targetId):
        ...
        for i in list(fr.index):
            ...
            zlines[zi]['lineFlux'] = (zlines[zi]['lineWave']**2) * fr.at[i, "LinemeasLineFlux"]* (1 / 2.99792458) * 10 ** 16
            zlines[zi]['lineFluxError'] = (zlines[zi]['lineWave']**2) * fr.at[i, "LinemeasLineFluxUncertainty"]* * (1 / 2.99792458) * 10 ** 16
